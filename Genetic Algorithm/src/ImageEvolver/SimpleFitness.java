...
{
  private static SimpleFitness instance = new SimpleFitness();
  ...
  public static SimpleFitness getSimpleFitnessSingleton()
  {
    return instance;
  }

  private SimpleFitness()
  {
  ...
  public int getSimpleFitness(BufferedImage source, BufferedImage target)
  {
    int fitness = 0;
    int numElements = 0;
